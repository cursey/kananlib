...
// x64 machine code (captured from an x64 build via --snapshot). MSVC's x86
// and x64 code generators use different calling conventions (x64 fastcall
// passes the first two integer args in RCX/RDX and favors register-direct
// arithmetic; x86 cdecl passes args on the stack via an EBP frame), so the
// two architectures produce genuinely different, non-interchangeable
// machine code for the same C++ source -- these bytes are NOT reused for
// x86; a separate x86-native snapshot follows in the #else branch.
...
#else
// x86 machine code (captured from an x86 build via --snapshot), following
// the exact same capture methodology as the x64 arrays above -- run
// `kananlib-stress-test.exe --snapshot` on an x86 build and paste the
// output here if these ever need regenerating (e.g. after a compiler
// upgrade changes codegen).

static const uint8_t frozen_synth_linear[] = {
    0x55,0x8b,0xec,0x8b,0x4d,0x08,0x8b,0x45,0x0c,0x03,0xc1,0x89,0x45,0x08,0x8b,0x45,
    0x08,0x03,0xc0,0x89,0x45,0x08,0x8b,0x45,0x08,0x2b,0xc1,0x89,0x45,0x08,0x8b,0x45,
    0x08,0x40,0x89,0x45,0x08,0x8b,0x45,0x08,0x5d,0xc3
}; // 42 bytes
...
static const uint8_t frozen_synth_if_else[] = {
    0x55,0x8b,0xec,0x8b,0x45,0x08,0x85,0xc0,0x7e,0x0b,0x83,0xc0,0x0a,0x89,0x45,0x08,
    0x8b,0x45,0x08,0x5d,0xc3,0x83,0xc0,0xf6,0x89,0x45,0x08,0x8b,0x45,0x08,0x5d,0xc3
}; // 32 bytes
...
static const uint8_t frozen_synth_loop[] = {
    0x55,0x8b,0xec,0x83,0xec,0x08,0x8b,0x4d,0x08,0xc7,0x45,0xf8,0x00,0x00,0x00,0x00,
    0xc7,0x45,0xfc,0x00,0x00,0x00,0x00,0x39,0x4d,0xfc,0x7d,0x19,0x0f,0x1f,0x40,0x00,
    0x8b,0x45,0xfc,0x03,0x45,0xf8,0x89,0x45,0xf8,0x8b,0x45,0xfc,0x40,0x89,0x45,0xfc,
    0x39,0x4d,0xfc,0x7c,0xeb,0x8b,0x45,0xf8,0x8b,0xe5,0x5d,0xc3
}; // 60 bytes
...
static const uint8_t frozen_synth_nested_diamond[] = {
    0x55,0x8b,0xec,0x51,0x8b,0x45,0x08,0x8b,0x4d,0x0c,0xc7,0x45,0xfc,0x00,0x00,0x00,
    0x00,0x85,0xc0,0x7e,0x1c,0x85,0xc9,0x7e,0x0c,0x03,0xc1,0x89,0x45,0xfc,0x8b,0x45,
    0xfc,0x8b,0xe5,0x5d,0xc3,0x2b,0xc1,0x89,0x45,0xfc,0x8b,0x45,0xfc,0x8b,0xe5,0x5d,
    0xc3,0x85,0xc9,0x7e,0x0c,0x2b,0xc8,0x89,0x4d,0xfc,0x8b,0x45,0xfc,0x8b,0xe5,0x5d,
    0xc3,0x03,0xc1,0xf7,0xd8,0x89,0x45,0xfc,0x8b,0x45,0xfc,0x8b,0xe5,0x5d,0xc3
}; // 79 bytes
...
static const uint8_t frozen_synth_multi_call[] = {
    0x55,0x8b,0xec,0x51,0xff,0x75,0x0c,0xff,0x75,0x08,0xe8,0xa1,0xce,0xff,0xff,0xff,
    0x75,0x08,0x89,0x45,0xfc,0x8b,0x45,0xfc,0x50,0xe8,0xb2,0xce,0xff,0xff,0xff,0x75,
    0x0c,0x89,0x45,0xfc,0x8b,0x45,0xfc,0x50,0xe8,0xc3,0xce,0xff,0xff,0x89,0x45,0xfc,
    0x83,0xc4,0x18,0x83,0x7d,0xfc,0x00,0x8b,0x45,0xfc,0x7e,0x11,0x6a,0x01,0x50,0xe8,
    0x6c,0xce,0xff,0xff,0x89,0x45,0xfc,0x83,0xc4,0x08,0x8b,0x45,0xfc,0x8b,0xe5,0x5d,
    0xc3
}; // 81 bytes
...
static const uint8_t frozen_synth_many_branches[] = {
    
}; // 361 bytes
...
static const uint8_t frozen_synth_deep_nested_loops[] = {
    
}; // 164 bytes
...
static const uint8_t frozen_synth_early_returns[] = {
    0x55,0x8b,0xec,0x8b,0x45,0x08,0x89,0x45,0x08,0x83,0x7d,0x08,0x00,0x7d,0x05,0x83,
    0xc8,0xff,0x5d,0xc3,0x8b,0x45,0x08,0x03,0x45,0x0c,0x89,0x45,0x08,0x83,0x7d,0x08,
    0x64,0x7e,0x07,0xb8,0x64,0x00,0x00,0x00,0x5d,0xc3,0x8b,0x45,0x08,0x0f,0xaf,0x45,
    0x10,0x89,0x45,0x08,0x83,0x7d,0x08,0x00,0x75,0x04,0x33,0xc0,0x5d,0xc3,0x8b,0x45,
    0x08,0x2b,0x45,0x14,0x89,0x45,0x08,0x83,0x7d,0x08,0xce,0x7d,0x07,0xb8,0xce,0xff,
    0xff,0xff,0x5d,0xc3,0x83,0x7d,0x08,0x32,0x7e,0x07,0xb8,0x32,0x00,0x00,0x00,0x5d,
    0xc3,0x8b,0x45,0x08,0x0f,0xaf,0x45,0x08,0x89,0x45,0x08,0xb8,0xe7,0x03,0x00,0x00,
    0x81,0x7d,0x08,0xe8,0x03,0x00,0x00,0x7f,0x03,0x8b,0x45,0x08,0x5d,0xc3
}; // 126 bytes
...
static const uint8_t frozen_synth_else_if_chain[] = {
    
}; // 323 bytes
...
static const uint8_t frozen_synth_call_branch_interleave[] = {
    
}; // 171 bytes
...
static const uint8_t frozen_synth_long_linear[] = {
    
}; // 576 bytes
...
#else
// x86 has no REX prefix and no RIP-relative addressing; the x64 blobs above
// (`sub rsp,0x28` = 48 83 EC 28, `mov rbp,rsp`-style REX-prefixed forms)
// decode as entirely different instructions if run through a 32-bit
// decoder. These are x86-native re-encodings of the SAME call/branch
// topology (same number of instructions, same call/branch graph), verified
// byte-for-byte via a standalone Capstone (CS_MODE_32) round-trip decode
// before being committed here.

// --- asm_simple_call: one caller, one callee ---
// RVA 0x00: caller — sub esp,0x28 / call callee / mov [esp+0x30],eax / mov eax,[esp+0x30] / add esp,0x28 / ret
// RVA 0x14: callee — lea eax,[ecx+edx] / ret
static const uint8_t frozen_asm_simple_call[] = {
    0x83,0xEC,0x28,                          // 0x00: sub esp, 0x28
    0xE8,0x0C,0x00,0x00,0x00,              // 0x03: call 0x14  (0x14 - 0x08 = 0x0C)
    0x89,0x44,0x24,0x30,                    // 0x08: mov [esp+0x30], eax
    0x8B,0x44,0x24,0x30,                    // 0x0C: mov eax, [esp+0x30]
    0x83,0xC4,0x28,                          // 0x10: add esp, 0x28
    0xC3,                                    // 0x13: ret
    0x8D,0x04,0x11,                          // 0x14: lea eax, [ecx+edx]
    0xC3,                                    // 0x17: ret
}; // 24 bytes

// --- asm_chained_calls: A calls B, B calls C ---
// RVA 0x00: func_a — sub esp,0x28 / call func_b / mov [esp+0x30],eax / mov eax,[esp+0x30] / add esp,0x28 / ret
// RVA 0x14: func_b — sub esp,0x28 / call func_c / mov [esp+0x30],eax / mov eax,[esp+0x30] / add esp,0x28 / ret
// RVA 0x28: func_c — lea eax,[ecx+edx] / imul eax,ecx / ret
static const uint8_t frozen_asm_chained_calls[] = {
    0x83,0xEC,0x28,                          // 0x00: sub esp, 0x28
    0xE8,0x0C,0x00,0x00,0x00,              // 0x03: call 0x14  (0x14 - 0x08 = 0x0C)
    0x89,0x44,0x24,0x30,                    // 0x08: mov [esp+0x30], eax
    ...
    0x83,0xC4,0x28,                          // 0x10: add esp, 0x28
    0xC3,                                    // 0x13: ret
    0x83,0xEC,0x28,                          // 0x14: sub esp, 0x28
    0xE8,0x0C,0x00,0x00,0x00,              // 0x17: call 0x28  (0x28 - 0x1C = 0x0C)
    0x89,0x44,0x24,0x30,                    // 0x1C: mov [esp+0x30], eax
    0x8B,0x44,0x24,0x30,                    // 0x20: mov eax, [esp+0x30]
    0x83,0xC4,0x28,                          // 0x24: add esp, 0x28
    0xC3,                                    // 0x27: ret
    0x8D,0x04,0x11,                          // 0x28: lea eax, [ecx+edx]
    0x0F,0xAF,0xC1,                          // 0x2B: imul eax, ecx
    0xC3,                                    // 0x2E: ret
}; // 47 bytes

// --- asm_call_and_branch: conditional branch + call, tests both branch + call-follow ---
// RVA 0x00: test ecx,ecx / jle skip(0x10) / sub esp,0x28 / call callee(0x13) / add esp,0x28 / ret
// RVA 0x10: skip — xor eax,eax / ret
// RVA 0x13: callee — lea eax,[ecx+edx] / ret
static const uint8_t frozen_asm_call_and_branch[] = {
    0x85,0xC9,                               // 0x00: test ecx, ecx
    0x7E,0x0C,                               // 0x02: jle 0x10  (0x10 - 0x04 = 0x0C)
    0x83,0xEC,0x28,                          // 0x04: sub esp, 0x28
    0xE8,0x07,0x00,0x00,0x00,              // 0x07: call 0x13  (0x13 - 0x0C = 0x07)
    0x83,0xC4,0x28,                          // 0x0C: add esp, 0x28
    0xC3,                                    // 0x0F: ret
    0x33,0xC0,                               // 0x10: xor eax, eax
    0xC3,                                    // 0x12: ret
    0x8D,0x04,0x11,                          // 0x13: lea eax, [ecx+edx]
    0xC3,                                    // 0x16: ret
}; // 23 bytes

// --- asm_multi_target_call: caller calls two different callees ---
// RVA 0x00: sub esp,0x28 / call callee_a(0x19) / mov[esp+0x30],eax / call callee_b(0x1D) / mov[esp+0x30],eax / add esp,0x28 / ret
// RVA 0x19: callee_a — lea eax,[ecx+edx] / ret
// RVA 0x1D: callee_b — sub eax,ecx / ret
static const uint8_t frozen_asm_multi_target_call[] = {
    0x83,0xEC,0x28,                          // 0x00: sub esp, 0x28
    0xE8,0x11,0x00,0x00,0x00,              // 0x03: call 0x19  (0x19 - 0x08 = 0x11)
    0x89,0x44,0x24,0x30,                    // 0x08: mov [esp+0x30], eax
    0xE8,0x0C,0x00,0x00,0x00,              // 0x0C: call 0x1D  (0x1D - 0x11 = 0x0C)
    0x89,0x44,0x24,0x30,                    // 0x11: mov [esp+0x30], eax
    0x83,0xC4,0x28,                          // 0x15: add esp, 0x28
    0xC3,                                    // 0x18: ret
    0x8D,0x04,0x11,                          // 0x19: lea eax, [ecx+edx]
    0xC3,                                    // 0x1C: ret
    0x2B,0xC1,                               // 0x1D: sub eax, ecx
    0xC3,                                    // 0x1F: ret
}; // 32 bytes
#endif
...
#else
    // With CONTINUE: caller (6 insns) + callee (2 insns) = 8 unique addresses
    STRESS_ASSERT(rvas_follow.count(0x00));  // sub esp
    STRESS_ASSERT(rvas_follow.count(0x03));  // call
    STRESS_ASSERT(rvas_follow.count(0x08));  // mov [esp+0x30], eax
    STRESS_ASSERT(rvas_follow.count(0x0C));  // mov eax, [esp+0x30]
    STRESS_ASSERT(rvas_follow.count(0x10));  // add esp
    STRESS_ASSERT(rvas_follow.count(0x13));  // ret
    STRESS_ASSERT(rvas_follow.count(0x14));  // callee: lea
    STRESS_ASSERT(rvas_follow.count(0x17));  // callee: ret
    STRESS_ASSERT(rvas_follow.size() == 8);

    // With STEP_OVER: only caller (6 insns), callee not visited
    STRESS_ASSERT(rvas_skip.count(0x00));
    STRESS_ASSERT(!rvas_skip.count(0x14));   // callee NOT visited
    STRESS_ASSERT(rvas_skip.size() == 6);
#endif
...
int test_asm_chained_calls() {
    ...
    // With CONTINUE: func_a (6) + func_b (6) + func_c (3) = 15 unique addresses
    STRESS_ASSERT(rvas_follow.count(0x00));  // func_a start
    STRESS_ASSERT(rvas_follow.count(0x14));  // func_b start
    STRESS_ASSERT(rvas_follow.count(0x28));  // func_c start
    STRESS_ASSERT(rvas_follow.count(0x2B));  // func_c: imul
    STRESS_ASSERT(rvas_follow.count(0x2E));  // func_c: ret
    STRESS_ASSERT(rvas_follow.size() == 15);

    // With STEP_OVER: only func_a (6 insns)
    STRESS_ASSERT(rvas_skip.count(0x00));
    STRESS_ASSERT(!rvas_skip.count(0x14));   // func_b NOT visited
    STRESS_ASSERT(!rvas_skip.count(0x28));   // func_c NOT visited
    STRESS_ASSERT(rvas_skip.size() == 6);
#endif
...
int test_asm_call_and_branch() {
    ...
    STRESS_ASSERT(rvas_follow.count(0x00));  // test ecx
    STRESS_ASSERT(rvas_follow.count(0x02));  // jle
    STRESS_ASSERT(rvas_follow.count(0x04));  // sub esp
    STRESS_ASSERT(rvas_follow.count(0x07));  // call
    STRESS_ASSERT(rvas_follow.count(0x0C));  // add esp
    STRESS_ASSERT(rvas_follow.count(0x0F));  // ret
    STRESS_ASSERT(rvas_follow.count(0x10));  // skip: xor eax
    STRESS_ASSERT(rvas_follow.count(0x12));  // skip: ret
    STRESS_ASSERT(rvas_follow.count(0x13));  // callee: lea
    STRESS_ASSERT(rvas_follow.count(0x16));  // callee: ret
    STRESS_ASSERT(rvas_follow.size() == 10);

    // With STEP_OVER: fall-through (6) + branch skip (2) = 8, callee not visited
    STRESS_ASSERT(rvas_skip.count(0x10));    // skip path IS visited (branch)
    STRESS_ASSERT(!rvas_skip.count(0x13));   // callee NOT visited
    STRESS_ASSERT(rvas_skip.size() == 8);
#endif
...
int test_asm_multi_target_call() {
    ...
    // With CONTINUE: caller (7) + callee_a (2) + callee_b (2) = 11 unique
    STRESS_ASSERT(rvas_follow.count(0x00));  // sub esp
    STRESS_ASSERT(rvas_follow.count(0x03));  // call callee_a
    STRESS_ASSERT(rvas_follow.count(0x0C));  // call callee_b
    STRESS_ASSERT(rvas_follow.count(0x19));  // callee_a: lea
    STRESS_ASSERT(rvas_follow.count(0x1C));  // callee_a: ret
    STRESS_ASSERT(rvas_follow.count(0x1D));  // callee_b: sub
    STRESS_ASSERT(rvas_follow.count(0x1F));  // callee_b: ret
    STRESS_ASSERT(rvas_follow.size() == 11);

    // With STEP_OVER: only caller (7), neither callee visited
    STRESS_ASSERT(!rvas_skip.count(0x19));   // callee_a NOT visited
    STRESS_ASSERT(!rvas_skip.count(0x1D));   // callee_b NOT visited
    STRESS_ASSERT(rvas_skip.size() == 7);
#endif
